...
## Темная тема
Ручек для переключения нет, она включается автоматически на основную страницу вкладки "Обучение"
- При возникновении желания переключить тему на светлую, перейдите по [адресу](chrome://extensions/) и выключите расширение
## Поддержка
